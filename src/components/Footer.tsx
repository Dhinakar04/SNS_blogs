...
const Footer = () => (
  <footer className="w-full bg-[#f8f8f8] border-t border-border pt-20 pb-32 md:pb-12 font-sans text-foreground">
    <div className="container-blog">
      {/* Top Section with Logo and Tagline + Navigation Grid */}
      <div className="flex flex-col lg:flex-row justify-between items-start pb-16 border-b border-border/70 gap-12 lg:gap-24">
        <div className="w-full lg:w-[320px]">
          <Link to="/" className="inline-block mb-6">
            <img src="/sns-logo.png" alt="SNS Groups" className="h-[60px] object-contain" />
          </Link>
          <div className="flex items-center gap-6">
            <h3 className="text-[18px] font-bold text-foreground leading-[1.4]">
              Redesigning Common Mind &<br />Business Towards Excellence
            </h3>
          </div>
        </div>

        {/* Navigation Grid Distributed */}
        <div className="grid grid-cols-2 sm:grid-cols-3 gap-x-12 xl:gap-x-24 gap-y-12 flex-1 w-full lg:w-auto">
          <div>
